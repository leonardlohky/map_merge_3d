...
struct MapMergingParams {
  ...
  Descriptor descriptor_type = Descriptor::FPFH;
  RefineMethod refine_method = RefineMethod::FAST_VGICP;
  EstimationMethod estimation_method = EstimationMethod::MATCHING;
  CorrespondenceMethod correspondence_method = CorrespondenceMethod::KDTREE;
